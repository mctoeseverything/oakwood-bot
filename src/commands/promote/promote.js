...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    try {
      ...
      console.error('[Promote] Membership fetch error:', err.message);
    ...
    if (oldRole && oldRole.rank >= executorRank) {
      return errorReply(interaction, `You cannot promote **@${targetRecord.roblox_name}** — their current rank (**${oldRole.rank} — ${oldRole.name}**) is equal to or higher than yours (**${executorRank}**).`);
    }
    ...
    if (newRole.rank >= executorRank) {
      return errorReply(interaction, `You cannot promote **@${targetRecord.roblox_name}** to **${newRole.rank} — ${newRole.name}** — that rank is equal to or higher than yours (**${executorRank}**).`);
    }
